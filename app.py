...
from model import AITravelCompanion
from tool_functions import SEED_INSTRUCTION, tools
...
wander_ai_manager: AITravelCompanion = AITravelCompanion()
...
st.chat_input(
    placeholder="Share 3 places in Antalya near each other that I can visit in the December vacations",
    key="input_user_msg",
